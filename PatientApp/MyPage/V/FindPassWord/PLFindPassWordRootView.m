...
@interface PLFindPassWordRootView ()
{
...
@implementation PLFindPassWordRootView
...
- (void)addViews
{
    ...
    [self.topBaseWhiteView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(singleViewHeight * 5);
    }];
    ...
    [self.baseScrollView setContentSize:CGSizeMake(viewSize.width, singleViewHeight * 5 + tipLabelHeight + 10 + 30 + self.sureButtonView.height + 10)];
...
- (void)clickSureButtonHandler
{
    ...
    [self.viewModel findPassWordRequest];
}
